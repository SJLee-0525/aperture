 ...
 *
 * @param {{ className?: string; delay?: number; stagger?: number; started: boolean; text: string }} props
 * @param {string | undefined} props.className
 * @param {number | undefined} props.delay
 * @param {number | undefined} props.stagger
