 ...
 *
 * `data-js` 는 "스크립트가 실행됐다"는 표식이다. 진입 애니메이션의 초기 `opacity: 0` 을
 * 이 속성 아래로 게이트해, JS 가 실행되지 않는 환경에서 랜딩의 진입 링크와 리드 문장이
 * 처음부터 보이게 한다.
 *
