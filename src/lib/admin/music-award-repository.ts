...
/** 수상은 문서가 작아 목록도 전체 필드를 쓴다 — live(listCrud.list)와 같은 모양. */
...
/**
 * 현재 콘텐츠 소스에 맞는 수상 저장소. live 는 기존 `listCrud` 산출물 그대로다.
 *
 * @returns {MusicAwardRepository} mock 이면 브라우저 로컬, live 면 Firestore 구현.
 */
