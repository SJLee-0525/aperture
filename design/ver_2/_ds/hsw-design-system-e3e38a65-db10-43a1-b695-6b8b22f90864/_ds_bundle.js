...
(() => {
  ...
  try {
    (() => {
      ...
      /* ---------- SVG GAUGE ---------- */
      function Gauge({ label, sub, value, size = 180, max = 100 }) {
        const r = size / 2 - 12;
        const c = 2 * Math.PI * r;
      ...
      function InfoCard({ label, value, pct }) {
        return /*#__PURE__*/ React.createElement(
          "div",
          {
            className: "info-card",
      ...
      /* ---------- PIPELINE LOG ---------- */
      function PipelineEntry({ tag, status, text, time, onClick }) {
        const stripColor =
          status === "active" ? "#FFC000" : status === "queued" ? "#917300" : "#555";
        return /*#__PURE__*/ React.createElement(
          "div",
          {
    ...
    __ds_ns.__errors.push({
      path: "ui_kits/dashboard/components.jsx",
